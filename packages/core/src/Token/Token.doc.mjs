...
export const docs = {
  ...
  theming: {
    targets: [
      ...
      {className: 'astryx-token-icon', visualProps: ['size']},
      {className: 'astryx-token-label', visualProps: ['size']},
      {className: 'astryx-token-end-content', visualProps: ['size']},
      {className: 'astryx-token-remove', visualProps: ['size']},
    ],
  },
  usage: {
    description:
