...
export const docs = {
  ...
  usage: {
    ...
    anatomy: [
      ...
      },
      {
        ...
        required: false,
        description:
          'One or two letters extracted from the name. Shown when no photo is available.',
      },
      {
        name: 'Default icon',
        required: false,
  ...
  components: [{name: 'AvatarStatusDot'}],
};
    ...
    bestPractices: [
      {
        guidance: true,
        description:
          'Always provide a name prop so the component can generate meaningful initials and alt text when the image fails to load.',
      },
      {
        guidance: true,
        description:
          'Use the status slot with AvatarStatusDot to indicate online presence or availability when relevant to the context.',
      },
      {
        guidance: true,
        description:
      ...
      },
      {
        guidance: false,
        description:
          "Use Avatar for decorative images or logos that aren't representing a person or entity. Use an image or icon component instead.",
      },
      {
        guidance: false,
        description:
          'Override the circular shape. Avatars are always round to maintain visual consistency across the system.',
      },
    ],
  },
};
    ...
    bestPractices: [
      {
        guidance: true,
        description:
          'Always pass a name for initials fallback and screen reader alt text.',
      },
      {
        guidance: true,
        description:
          'Match size to context: xsm/sm inline, md/lg in lists, xl for profiles.',
      },
      {
        guidance: true,
        description:
          'Add a status dot in chat or team views where availability matters.',
      },
      {
        guidance: true,
        description:
          'When wrapping Avatar in your own Tooltip or HoverCard, set tooltip={false} so the built-in name tooltip does not overlap yours.',
      },
      {
        guidance: true,
        description:
          'Interactive avatars (href/onClick) need name or alt; without one they warn in development.',
      },
      {
        guidance: false,
        description:
      ...
      },
      {
        guidance: false,
        description:
          'Use for logos or product images. Use an image or icon instead.',
      },
      {
        guidance: false,
        description:
          'Force a square or custom shape. Avatars are always circular.',
      },
    ],
  },
  propDescriptions: {
    ...
    onClick:
      'click handler → renders <button> when no href. Needs alt/name; warns in development without one.',
  },
  components: [
    {
      name: 'AvatarStatusDot',
      description: 'size-aware status indicator rendered in the Avatar corner',
    },
  ],
};
