...
export const inputWrapperStyles = stylex.create({
  base: {
    ...
    display: 'flex',
    alignItems: 'center',
    gap: `var(--_input-content-gap, var(--power-search-content-gap, var(--tokenizer-gap, ${spacingVars['--spacing-2']})))`,
    paddingBlock: `var(--_input-padding-block, var(--power-search-padding-block, var(--tokenizer-padding-block, ${spacingVars['--spacing-1']})))`,
    paddingInline: `var(--_input-padding-inline, var(--power-search-padding-inline, var(--tokenizer-padding-inline, ${spacingVars['--spacing-2']})))`,
    borderWidth: borderVars['--border-width'],
    borderStyle: 'solid',
    borderColor: {
      default: `var(--power-search-border-color, var(--_input-border-color, ${colorVars['--color-border-emphasized']}))`,
      ':focus-within': `var(--power-search-focus-border-color, var(--_input-focus-border-color, ${colorVars['--color-accent']}))`,
    },
    '--_field-radius': `var(--power-search-radius, var(--_input-radius, ${radiusVars['--radius-element']}))`,
    borderRadius: 'var(--_field-radius)',
    backgroundColor: `var(--power-search-background, var(--_input-background, ${colorVars['--color-background-surface']}))`,
    ...
    boxShadow: {
      ...
      ':focus-within': `var(--power-search-focus-ring, var(--_input-focus-ring, inset 0px 0px 0px 2px ${colorVars['--color-accent-muted']}))`,
    },
    outline: 'none',
  },
  disabled: {
    cursor: 'default',
    opacity: 'var(--_input-disabled-opacity, 0.5)',
